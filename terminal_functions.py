...
# Terminal Functions
# Created By- Antar Mukhopadhyaya
# Date: 20.10.2020

# Check: isfile and isdir functions
...
def on_start(start_path):
    ...
    if platform.system().lower() == 'windows':
        ...
        print(Fore.RED+"PyTerminal is only Available for windows...")
        print(Style.RESET_ALL)
        sys.exit()
...
def read_file(file_name):
    ...
    if os.path.isfile(file_path):
        ...
        print(Fore.YELLOW +
              "*************** File: "+file_name+" & Size: "+file_size+" Bytes ****************** \n")
        print(Style.RESET_ALL)
...
def remove_file_or_directory(file_name):
    ...
    #    os.rmdir(full_path)
    # else:
    #    print(Fore.RED + "Error >> The specified file or directory doesn't exist.")
    #    print(Style.RESET_ALL)
    if os.path.isfile(file_name):
        ...
        print(Fore.RED + "The Specified path doesn't exist")
        print(Style.RESET_ALL)
...
def create_file(file_name):
    ...
    if os.path.isfile(file_name):
        print(Fore.YELLOW + " Warning:  >>>  File already exists. Write existing file ?")
        print(Style.RESET_ALL)
    else:
        f = open(file_name, "a")
        print(
            f"***************** File: {file_name}  & Mode: Write *****************  \n")
...
def unzip_file(query):
    if "current_dir" in query:
        ...
        if os.path.isfile(file_path):
            ...
            print(Fore.RED + "Error >>> Specified File does'nt exists.")
            print(Style.RESET_ALL)
...
def move_file():
    ...
    if os.path.exists(full_path):
        ...
        print(Fore.RED + "Error >>> File does not exists.")
        print(Style.RESET_ALL)
